    ...
    <div className="card">
      <div className="leftSider">
        <div className="leftSiderContent">
          <BlockSlider arrows={false} slidesToShow={1} swipeOnClick infinite>
            {images.slice(0, 2).map((im) => (
              <img key={im.id} src={base64ToUrl(im.base64, im.mimeType)} className="streetcodeImg" alt={im.imageDetails?.alt} />
            ))}
          </BlockSlider>
        </div>
      </div>
