...
const StreetcodeContent = () => {
  ...
  return (
    <div className="streetcodeContainer">
      ...
      <ProgressBar>
        <MainBlock streetcode={streetcode} setActiveTagId={setActiveTagId} setActiveBlock={setActiveBlock} />
        <TextBlockComponent />
        <InterestingFactsComponent />
        <TimelineBlockComponent />
        {/* <MapBlock /> */}
      ...
      <TickerBlock />
      <TagsModalComponent activeTagId={activeTagId} setActiveTagId={setActiveTagId} activeTagBlock={activeBlock} />
